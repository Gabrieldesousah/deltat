        ...
        <div class="columns medium-8 content">
            ...
            <fieldeset>
                ...
                <?php
                    ...
                    echo $this->Form->input('thumbnail', array('label' => array(
                            'class' => 'title',
                            'text' => 'Imagem menor'
                        )));
                    echo $this->Form->input('local', array('label' => array(
                            'class' => 'title',
                            'text' => 'Local onde foi tirada'
                        )));
                    echo $this->Form->input('category', array('label' => array(
                            'class' => 'title',
